...
import { Building2, Phone, User, MapPin, CheckCircle, XCircle, Globe } from "lucide-react";
...
export default function RegionDashboard() {
  ...
  useEffect(() => {
    if (!userId) return;
    Promise.all([
      ApiCall(`/api/v1/admin/regions/getById/${userId}`, "GET"),
      ApiCall(`/api/v1/admin/regions/getRegionOrganizations`, "GET", null, { regionId: userId }),
            ...
            <div className="flex-1">
              ...
              <div className="mt-2 flex flex-wrap gap-4 text-sm text-gray-600">
                ...
                {profile.provinceName && (
                  <span className="flex items-center gap-1">
                    <Globe size={13} /> {profile.provinceName}
                  </span>
                )}
                {profile.location && (
                  <span className="flex items-center gap-1">
